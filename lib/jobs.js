...
export const CONSUMERS = {
  ...
  lighthouse_desktop: { durable: 'lighthouse_desktop', filter: SUBJECTS.lighthouseDesktop, ackWait: 300, maxDeliver: 3, maxAckPending: 16, role: 'browser' },
  lighthouse_mobile: { durable: 'lighthouse_mobile', filter: SUBJECTS.lighthouseMobile, ackWait: 300, maxDeliver: 3, maxAckPending: 16, role: 'browser' },

...
export function extractContacts(html, { defaultCountry = 'PT' } = {}) {
  ...
  // Telefone geral (internacional, E.164) — ver lib/phone.js.
  const ph = extractPhone(s, { defaultCountry });
  return { email, phone: ph ? ph.e164 : null, phone_country: ph ? ph.country : null };
}

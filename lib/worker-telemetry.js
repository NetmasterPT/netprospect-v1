...
// Cliente Redis partilhado (mesma ligação da telemetria) para outros usos fail-soft — ex. a quota
// partilhada do pool de verify (lib/verify-providers.js). Devolve null se REDIS_URL vazio / Redis em baixo.
export async function redisClient() { return cli(); }

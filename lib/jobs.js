...
export const CONSUMERS = {
  ...
  // (/api/autoscale) validou subir 6→12. Override-ável por LIGHTHOUSE_MAX_ACK (default 12): todos os
  // hosts browser fazem ensure deste consumer, por isso o default fleet-wide evita divergência.
  lighthouse_desktop: { durable: 'lighthouse_desktop', filter: SUBJECTS.lighthouseDesktop, ackWait: 300, maxDeliver: 3, maxAckPending: +(process.env.LIGHTHOUSE_MAX_ACK || 12), role: 'browser' },
  lighthouse_mobile: { durable: 'lighthouse_mobile', filter: SUBJECTS.lighthouseMobile, ackWait: 300, maxDeliver: 3, maxAckPending: +(process.env.LIGHTHOUSE_MAX_ACK || 12), role: 'browser' },

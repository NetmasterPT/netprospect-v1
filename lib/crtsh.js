...
// connectionTimeoutMillis é ESSENCIAL: o crt.sh:5432 está frequentemente em baixo (SYN sem resposta);
// sem timeout, o pg.Client.connect() pendura indefinidamente (bloqueava a descoberta multi-fonte).
const DB_CONFIG = { host: 'crt.sh', port: 5432, user: 'guest', database: 'certwatch', connectionTimeoutMillis: 8000, query_timeout: 20000, statement_timeout: 20000 };

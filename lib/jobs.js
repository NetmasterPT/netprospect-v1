...
export const CONSUMERS = {
  ...
  // Reativado CONTROLADO (2026-07-19) a maxAckPending=4: o subfinder abre dezenas de conexões cada; com 12
  // concorrentes esgotava sockets/fds → node-fetch "fetch failed" → 99% órfãos. 4 fleet-wide (~1/worker)
  // mantém o node-fetch saudável. Aplicado via DELETE+recriação do durável (ensureConsumer não altera
  // maxAckPending a quente). ~4×20s = ~17k/dia. Com CERTSPOTTER_API_KEY (TODO-KEYS.md) sobe-se depois.

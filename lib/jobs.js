...
export const CONSUMERS = {
  ...
  // Reativado 2026-07-19: já NÃO depende só do crt.sh (SPOF instável). O handler usa lib/subdomains.js
  // multi-fonte (certspotter + crt.sh HTTP/PG + securitytrails/censys/subfinder), com fallback e timeouts
  // por fonte → drena mesmo com o crt.sh em baixo. maxAckPending modesto p/ não estourar os free tiers.

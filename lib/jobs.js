...
export const CONSUMERS = {
  ...
  // maxAckPending = teto FLEET-WIDE de lighthouse em paralelo. Era 16 (×2 = 32 Chrome) → o hel1
  // (4 réplicas, 0ms ao NATS) agarrava quase tudo e o Chrome abortava sob contenção (perda ~60%).
  // Baixado para 6 (×2 = 12 Chrome fleet-wide) para reduzir a instabilidade; o retry apanha o resto.
  lighthouse_desktop: { durable: 'lighthouse_desktop', filter: SUBJECTS.lighthouseDesktop, ackWait: 300, maxDeliver: 3, maxAckPending: 6, role: 'browser' },
  lighthouse_mobile: { durable: 'lighthouse_mobile', filter: SUBJECTS.lighthouseMobile, ackWait: 300, maxDeliver: 3, maxAckPending: 6, role: 'browser' },

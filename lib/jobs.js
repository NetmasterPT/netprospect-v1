...
export const CONSUMERS = {
  ...
  // (/api/autoscale) validou 6→12 (aplicado, sem pico de abortos ~0,44/min) e depois 12→24; adotámos
  // 20 (operador — margem sobre o Chromium). Override-ável por LIGHTHOUSE_MAX_ACK (default 20): todos os
  // hosts browser fazem ensure deste consumer, por isso o default fleet-wide evita divergência.

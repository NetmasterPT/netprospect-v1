...
export const isTransientJobErr = (e) =>
  ...
  /fetch failed|ECONNRESET|socket hang up|terminated|network|ETIMEDOUT|EAI_AGAIN|ENOTFOUND|502|503|504|429|timeout|aborted|exhausted|unavailable|under pressure|service_unavailable/i.test(
